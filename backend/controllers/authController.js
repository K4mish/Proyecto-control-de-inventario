...
export const inicioSesion = async (req, res) => {
    try {
        ...
        if (!correo || !contrasena) return res.status(400).json({ mensaje: 'Faltan datos requeridos' });
